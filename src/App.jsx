                ...
                <div className="max-w-6xl mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
                        ...
                        <img 
                            ...
                            className="h-18 md:h-18 w-auto object-contain hover:scale-110 transition-transform duration-300 drop-shadow-md rounded px-2 py-1"
                        />
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                notify(data.message || "Gagal memproses", "error");
            }
        } catch (err) {
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative font-sans">
            ...
            <div className="w-full max-w-md bg-white border border-gray-100 p-8 rounded-3xl shadow-2xl relative z-10 animate-in zoom-in duration-300">
                ...
                <div className="text-center mb-8">
                    ...
                    {mode === 'register' && <p className="text-xs text-gray-400 font-medium">Lengkapi data diri Anda untuk mendaftar</p>}
                </div>
