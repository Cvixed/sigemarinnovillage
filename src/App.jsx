...
{mode === 'register' && (
    <form onSubmit={handleSubmit} className="mt-6 space-y-2">
        <div className="mb-5">
            <label className="block text-xs font-bold text-blue-900 uppercase mb-2 ml-1">Peran Pengguna</label>
            <select 
                name="role" 
                value={form.role} 
                onChange={handleChange} 
                className="w-full bg-white border border-gray-300 text-gray-700 text-sm rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-orange-500 outline-none shadow-sm"
            >
        ...
        {/* Input Nama Lengkap (WAJIB ADA) */}
        <OrangeInput 
            label="Nama Lengkap" 
            name="fullName" 
            placeholder="Nama lengkap Bunda/Ayah" 
            value={form.fullName} 
            onChange={handleChange} 
        />
        ...
        <div className="pt-2">
            <button disabled={loading} className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 rounded-xl shadow-lg transition active:scale-95 mb-6 flex justify-center items-center gap-2">
